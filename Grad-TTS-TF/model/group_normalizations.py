...
# (GitHub): https://github.com/keras-team/keras/blob/v2.12.0/keras/layers/normalization/group_normalization.py
# (Tensorflow Documentation): https://www.tensorflow.org/api_docs/python/tf/keras/layers/GroupNormalization
