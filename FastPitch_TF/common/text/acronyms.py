...
hardcoded_acronyms = [
	...
	'CES', 'LRA', 'PC', 'NBA', 'BBL', 'OS', 'IRS', 'SAC', 'UV', 'CEO', 
	'TV', 'CNN', 'MSS', 'GSA', 'USSR', 'DNA', 'PRS', 'TSA', 'US', 
	'GPU', 'USA', 'FPCC', 'CIA'
]

# Words and acronyms that should be read as regular words, e.g., NATO,
# HAPPY, etc.
...
def spell_acronyms(text):
	text = re.sub(
		_non_uppercase_re, 
		lambda m: non_uppercase_exceptions[m.group(0).lower()], 
		text
	)
