# audio.py
# Helper module for audio pulled from Rayhane's Tacotron 2 audio
# preprocessing module under the same name.
# Tensorflow 2.4.0
# Windows/MacOS/Linux
# Python 3.7
...
# @param: sr, the target sampling rate.
# @return: returns numpy ndarray of the audio time series data.
def load_wav(path, sr):
	return librosa.core.load(path, sr=sr)[0]


# Save the wav file with scipy's wavfile.
# @param: wav, the numpy ndarray of the audio time series data.
# @param: path, the path to the audio (wav) file.
