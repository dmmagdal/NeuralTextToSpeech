# preprocess.py
# Helper module for audio and audio preprocessing pulled from Rayhane's
# Tacotron 2 audio preprocessing module under the same name.
# Tensorflow 2.4.0
# Windows/MacOS/Linux
# Python 3.7
...
from wavenet_vocoder.util import is_mulaw, is_mulaw_quantize, mulaw, 
from wavenet_vocoder.util import mulaw_quantize
